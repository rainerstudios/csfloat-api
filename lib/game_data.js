    ...
    */
    addAdditionalItemProperties(iteminfo) {
        ...
        if (image_name in this.items_game_cdn) {
            ...
            // Fallback: Generate CDN URL directly if items_game_cdn is not available
            // Format: https://steamcdn-a.akamaihd.net/apps/730/icons/econ/default_generated/{weapon_name}{skin_name}_light_large.png

...
class GameData {
    ...
    */
    loadFiles() {
        ...
        if (fs.existsSync('game_files/items_to_images.json')) {
            let data = fs.readFileSync('game_files/items_to_images.json', 'utf8');
    ...
    */
    update() {
        ...
        utils.downloadFile(this.items_game_to_images_url, (data) => {
            if (data) {
                winston.debug('Fetched items_to_images.json');
                this.items_to_images = this.parseItemsImages(data);
                fs.writeFileSync('game_files/items_to_images.json', data, 'utf8');
            }
            else winston.error('Failed to fetch items_to_images.json');
        });
    ...
    */
    addAdditionalItemProperties(iteminfo) {
        ...
        // Get the image url from steamapis
